...
<div id="subhead">
    <div id="menu" class="navbar">
        ...
        <div class="problem_set">
            <a style="width: 100px;" class="btn <?php if (substr_compare($url,"problemset.php",0,14,TRUE)==0 || substr_compare($url,"problem_add_page.php",0,20,TRUE)==0 || substr_compare($url,"problem_list.php",0,16,TRUE)==0) echo $now; ?>"
            <?php
            if ($flag){
        ...
        <a style="width: 100px;" class="btn <?php if (substr_compare($url,"status.php",0,10,TRUE)==0) echo $now; ?>" href="../status.php"><i class="icon-check"></i>Status</a>
        <div class="contest_set">
            <a style="width: 100px;" class="btn <?php if (substr_compare($url,"contest.php",0,11,TRUE)==0 || substr_compare($url,"contest_add_page.php",0,20,TRUE)==0 || substr_compare($url,"contest_list.php",0,16,TRUE)==0) echo $now; ?>"
            <?php
            if ($flag){
