...
<div id="wrapper">
    ...
    <div id=main style="margin-left: 2cm">
        ...
        <p><font color=green>Q</font>:这个在线裁判系统使用什么样的编译器和编译选项?<br>
            <font color=red>A</font>:系统运行于 Linux. 使用<a href="http://gcc.gnu.org/">GNU GCC/G++</a> 作为C/C++编译器,用 <a href="http://www.oracle.com/technetwork/java/index.html">sun-java-jdk1.6</a> 编译 Java. 对应的编译选项如下:<br>
        </p>
        <table border="1">
            <tr>
                <td>C:</td>
        ...
        <p>  编译器版本为（系统可能升级编译器版本，这里直供参考）:<br>
            ...
            <font color=blue>java version "1.6.0_22"<br></font></p>
        <hr>
