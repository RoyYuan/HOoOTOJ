...
<div id="subhead">
    <div id="menu" class="navbar">
        ...
        <div class="problem_set">
            <a style="width: 100px;" class="btn <?php if ($url=="problemset.php" || $url=="admin/problem_add_page.php") echo $now; ?>"
            <?php
            if ($flag){
...
<!--        <a class="btn --><?php //if ($url=="problemset.php") echo $now; ?><!--" href="problemset.php"><i class="icon-question-sign"></i>题库</a>-->
        <a style="width: 100px;" class="btn <?php if ($url=="status.php") echo $now; ?>" href="status.php"><i class="icon-check"></i>Status</a>
        <div class="contest_set">
            <a style="width: 100px;" class="btn <?php if ($url=="contest.php" || $url=="admin/contest_add_page.php") echo $now; ?>"
            <?php
            if ($flag){
